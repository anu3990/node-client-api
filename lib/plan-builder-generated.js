...
/**
    * Creates a reference to the URI lexicon, for use as a parameter to cts:value-tuples. This function requires the URI lexicon to be enabled, otherwise it throws an exception. This reference returns URIs as IRIs. Provides a client interface to a server function. See {@link http://docs.marklogic.com/cts.iriReference|cts.iriReference}
    * @method planBuilder.cts#iriReference
    * @since 2.1.1

    * @returns { CtsReference }
    */
iriReference(...args) {
    bldrbase.checkMaxArity('cts.iriReference', args.length, 0);
    return new types.CtsReference('cts', 'iri-reference', args);
    }
/**
...
/**
    ...
    * @since 2.1.1
    * @param { XsAnyAtomicType } [vertices] - The waypoints of the linestring, given in order. Alternatively, the vertices may be provided as a string that follows the well-known text (WKT) scheme for a linestring.
...
/**
    ...
    * @since 2.1.1
    * @param { XsDouble } [latitudeOrWkt] - The latitude of the point. Alternatively, the vertex may be provided as a string that follows the well-known text (WKT) scheme for a point.
    * @param { XsDouble } [longitude] - The longitude of the point. If you supply a WKT string as latitude, this parameter must not be supplied.
    * @returns { CtsPoint }
    */
point(...args) {
...
/**
    * Compares geospatial regions to see if they fulfill the 'contains' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.contains|geo.contains}
    * @method planBuilder.geo#contains
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of contains.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of contains.
...
contains(...args) {
    ...
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.contains', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.contains', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'contains', checkedArgs);
...
/**
    * Compares geospatial regions to see if they fulfill the 'covered by' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.coveredBy|geo.coveredBy}
    * @method planBuilder.geo#coveredBy
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of covered-by.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of covered-by.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
coveredBy(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.coveredBy', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.coveredBy', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'covered-by', checkedArgs);

    }
/**
    * Compares geospatial regions to see if they fulfill the 'covers' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.covers|geo.covers}
    * @method planBuilder.geo#covers
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of covers.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of covers.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
covers(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.covers', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.covers', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'covers', checkedArgs);

    }
/**
    * Compares geospatial regions to see if they fulfill the 'crosses' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.crosses|geo.crosses}
    * @method planBuilder.geo#crosses
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of crosses.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of crosses.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
crosses(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.crosses', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.crosses', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'crosses', checkedArgs);
...
/**
    * Compares geospatial regions to see if they fulfill the 'disjoint' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.disjoint|geo.disjoint}
    * @method planBuilder.geo#disjoint
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of disjoint.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of disjoint.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
disjoint(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.disjoint', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.disjoint', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'disjoint', checkedArgs);
...
/**
    * Compares geospatial regions to see if they fulfill the 'equals' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.equals|geo.equals}
    * @method planBuilder.geo#equals
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of equals.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of equals.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
equals(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.equals', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.equals', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'equals', checkedArgs);
...
/**
    * Compares geospatial regions to see if they fulfill the 'intersects' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.intersects|geo.intersects}
    * @method planBuilder.geo#intersects
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of intersects.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of intersects.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
intersects(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.intersects', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.intersects', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'intersects', checkedArgs);

    }
/**
    * Compares geospatial regions to see if they fulfill the 'overlaps' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.overlaps|geo.overlaps}
    * @method planBuilder.geo#overlaps
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of overlaps.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of overlaps.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
overlaps(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.overlaps', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.overlaps', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'overlaps', checkedArgs);
...
/**
    * Compares geospatial regions to see if they fulfill the 'touches' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.touches|geo.touches}
    * @method planBuilder.geo#touches
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of touches.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of touches.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
touches(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.touches', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.touches', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'touches', checkedArgs);
...
/**
    * Compares geospatial regions to see if they fulfill the 'within' DE-9IM relation. Provides a client interface to a server function. See {@link http://docs.marklogic.com/geo.within|geo.within}
    * @method planBuilder.geo#within
    * @since 2.1.1
    * @param { CtsRegion } [region1] - The first geospatial region to compare. This region is the left operand of within.
    * @param { CtsRegion } [region2] - The second geospatial region to compare. This region is the right operand of within.
    * @param { XsString } [options] - Options to this operation. The default is (). Available options:   "coordinate-system=string" Use the given coordinate system. Valid values are:  wgs84The WGS84 coordinate system with degrees as the angular unit. wgs84/radiansThe WGS84 coordinate system with radians as the angular unit. wgs84/doubleThe WGS84 coordinate system at double precision with degrees as the angular unit. wgs84/radians/doubleThe WGS84 coordinate system at double precision with radians as the angular unit. etrs89The ETRS89 coordinate system. etrs89/doubleThe ETRS89 coordinate system at double precision. rawThe raw (unmapped) coordinate system. raw/doubleThe raw coordinate system at double precision.   "precision=value" Use the coordinate system at the given precision. Allowed values: float and double. "units=value" Measure distance, radii of circles, and tolerance in the specified units. Allowed values: miles (default), km, feet, meters. "tolerance=distance" Tolerance is the largest allowable variation in geometry calculations. If the distance between two points is less than tolerance, then the two points are considered equal. For the raw coordinate system, use the units of the coordinates. For geographic coordinate systems, use the units specified by the units option. 
    * @returns { XsBoolean }
    */
within(...args) {
    ...
    const paramdefs = [['region-1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['region-2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.within', 2, new Set(['region-1', 'region-2', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('geo.within', 2, false, paramdefs, args);
    return new types.XsBoolean('geo', 'within', checkedArgs);
...
class VecExpr {
  ...
  /**
    ...
    * @param { VecVector } [vector2] - The second addend vector.
    * @returns { VecVector }
    */
add(...args) {
    const namer = bldrbase.getNamer(args, 'vector1');
    const paramdefs = [['vector1', [types.VecVector, PlanColumn, PlanParam], false, false], ['vector2', [types.VecVector, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.add', 2, new Set(['vector1', 'vector2']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.add', 2, false, paramdefs, args);
    return new types.VecVector('vec', 'add', checkedArgs);
...
/**
    ...
    */
base64Decode(...args) {
    const paramdef = ['base64-vector', [types.XsString, PlanColumn, PlanParam], false, false];
    const checkedArgs = bldrbase.makeSingleArgs('vec.base64Decode', 1, paramdef, args);
    return new types.VecVector('vec', 'base64-decode', checkedArgs);
    }
/**
    * Returns the base64 encoding of the vector. Useful for compressing a high-dimensional float vector represented as a string into fewer characters. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.base64Encode|vec.base64Encode}
    * @method planBuilder.vec#base64Encode
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector to base64 encode.
    * @returns { XsString }
    */
base64Encode(...args) {
    const paramdef = ['vector1', [types.VecVector, PlanColumn, PlanParam], false, false];
    const checkedArgs = bldrbase.makeSingleArgs('vec.base64Encode', 1, paramdef, args);
    return new types.XsString('vec', 'base64-encode', checkedArgs);
    }
/**
    * Returns the cosine of the angle between two vectors. The vectors must be of the same dimension. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.cosine|vec.cosine}
    * @method planBuilder.vec#cosine
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector from which to calculate the cosine with vector2.
...
cosine(...args) {
    ...
    const paramdefs = [['vector1', [types.VecVector, PlanColumn, PlanParam], false, false], ['vector2', [types.VecVector, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.cosine', 2, new Set(['vector1', 'vector2']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.cosine', 2, false, paramdefs, args);
    return new types.XsDouble('vec', 'cosine', checkedArgs);

    }
/**
    * Returns the cosine distance between two vectors. The vectors must be of the same dimension. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.cosineDistance|vec.cosineDistance}
    * @method planBuilder.vec#cosineDistance
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector from which to calculate the cosine distance to vector2.
    * @param { VecVector } [vector2] - The vector from which to calculate the cosine distance to vector1.
    * @returns { XsDouble }
    */
cosineDistance(...args) {
    const namer = bldrbase.getNamer(args, 'vector1');
    const paramdefs = [['vector1', [types.VecVector, PlanColumn, PlanParam], false, false], ['vector2', [types.VecVector, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.cosineDistance', 2, new Set(['vector1', 'vector2']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.cosineDistance', 2, false, paramdefs, args);
    return new types.XsDouble('vec', 'cosine-distance', checkedArgs);

    }
/**
    * Returns the dimension of the vector passed in. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.dimension|vec.dimension}
    * @method planBuilder.vec#dimension
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector to find the dimension of.
    * @returns { XsUnsignedInt }
    */
dimension(...args) {
    const paramdef = ['vector1', [types.VecVector, PlanColumn, PlanParam], false, false];
    const checkedArgs = bldrbase.makeSingleArgs('vec.dimension', 1, paramdef, args);
    return new types.XsUnsignedInt('vec', 'dimension', checkedArgs);
    }
/**
    * Returns the dot product between two vectors. The vectors must be of the same dimension. Use this function to calculate similarity between vectors if you are certain they are both of magnitude 1. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.dotProduct|vec.dotProduct}
    * @method planBuilder.vec#dotProduct
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector from which to calculate the dot product with vector2.
    * @param { VecVector } [vector2] - The vector from which to calculate the dot product with vector1.
    * @returns { XsDouble }
    */
dotProduct(...args) {
    const namer = bldrbase.getNamer(args, 'vector1');
    const paramdefs = [['vector1', [types.VecVector, PlanColumn, PlanParam], false, false], ['vector2', [types.VecVector, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.dotProduct', 2, new Set(['vector1', 'vector2']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.dotProduct', 2, false, paramdefs, args);
    return new types.XsDouble('vec', 'dot-product', checkedArgs);

    }
/**
    * Returns the Euclidean distance between two vectors. The vectors must be of the same dimension. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.euclideanDistance|vec.euclideanDistance}
    * @method planBuilder.vec#euclideanDistance
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector from which to calculate the Euclidean distance to vector2.
    * @param { VecVector } [vector2] - The vector from which to calculate the Euclidean distance to vector1.
    * @returns { XsDouble }
    */
euclideanDistance(...args) {
    ...
    const paramdefs = [['vector1', [types.VecVector, PlanColumn, PlanParam], false, false], ['vector2', [types.VecVector, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.euclideanDistance', 2, new Set(['vector1', 'vector2']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.euclideanDistance', 2, false, paramdefs, args);
    return new types.XsDouble('vec', 'euclidean-distance', checkedArgs);

    }
/**
    * Returns the element at the k-th index of the vector. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.get|vec.get}
...
get(...args) {
    const namer = bldrbase.getNamer(args, 'vector1');
    const paramdefs = [['vector1', [types.VecVector, PlanColumn, PlanParam], false, false], ['k', [types.XsUnsignedInt, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.get', 2, new Set(['vector1', 'k']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.get', 2, false, paramdefs, args);
    return new types.XsFloat('vec', 'get', checkedArgs);

    }
/**
    * Returns the magnitude of the vector. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.magnitude|vec.magnitude}
    * @method planBuilder.vec#magnitude
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector to find the magnitude of.
    * @returns { XsDouble }
    */
magnitude(...args) {
    const paramdef = ['vector1', [types.VecVector, PlanColumn, PlanParam], false, false];
    const checkedArgs = bldrbase.makeSingleArgs('vec.magnitude', 1, paramdef, args);
    return new types.XsDouble('vec', 'magnitude', checkedArgs);
    }
/**
    * Returns the vector passed in, normalized to a length of 1. Provides a client interface to a server function. See {@link http://docs.marklogic.com/vec.normalize|vec.normalize}
    * @method planBuilder.vec#normalize
    * @since 2.1.1
    * @param { VecVector } [vector1] - The vector to normalize.
    * @returns { VecVector }
    */
normalize(...args) {
    const paramdef = ['vector1', [types.VecVector, PlanColumn, PlanParam], false, false];
...
/**
    ...
    * @param { VecVector } [vector2] - The subtrahend vector.
    * @returns { VecVector }
    */
subtract(...args) {
    const namer = bldrbase.getNamer(args, 'vector1');
    const paramdefs = [['vector1', [types.VecVector, PlanColumn, PlanParam], false, false], ['vector2', [types.VecVector, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.subtract', 2, new Set(['vector1', 'vector2']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.subtract', 2, false, paramdefs, args);
    return new types.VecVector('vec', 'subtract', checkedArgs);
...
subvector(...args) {
    ...
    const paramdefs = [['vector', [types.VecVector, PlanColumn, PlanParam], false, false], ['start', [types.XsUnsignedInt, PlanColumn, PlanParam], false, false], ['length', [types.XsUnsignedInt, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
...
/**
    ...
    */
vector(...args) {
    const paramdef = ['values', [types.XsAnyAtomicType, PlanColumn, PlanParam], false, true];
    const checkedArgs = bldrbase.makeSingleArgs('vec.vector', 1, paramdef, args);
...
/**
    ...
    * @param { XsDouble } [distance] - The distance between the vector in the matching document and the query vector. Examples, the result of a call to ovec:cosine-distance() or ovec:euclidean-distance().
    * @param { XsDouble } [distanceWeight] - The weight of the vector distance on the annScore. This value is a positive coefficient that scales the distance. A larger distanceWeight produces a lower annScore for the same distance. The default value is 1.
    * @param { XsDouble } [weight] - The weight of the annScore in the final hybrid score. This value is a coefficient between 0 and 1, where 0 gives full weight to the cts score and 1 gives full weight to the annScore. The default value is 0.5.
    * @returns { XsUnsignedLong }
    */
vectorScore(...args) {
    const namer = bldrbase.getNamer(args, 'score');
    const paramdefs = [['score', [types.XsUnsignedInt, PlanColumn, PlanParam], false, false], ['distance', [types.XsDouble, PlanColumn, PlanParam], false, false], ['distanceWeight', [types.XsDouble, PlanColumn, PlanParam], false, false], ['weight', [types.XsDouble, PlanColumn, PlanParam], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'vec.vectorScore', 2, new Set(['score', 'distance', 'distanceWeight', 'weight']), paramdefs, args) :
        bldrbase.makePositionalArgs('vec.vectorScore', 2, false, paramdefs, args);
    return new types.XsUnsignedLong('vec', 'vector-score', checkedArgs);
...
/**
    * Returns a string representing the dayname value in the localized value of arg.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/xdmp.daynameFromDate|xdmp.daynameFromDate}
...
/**
    ...
    * @param { XsString } [language] - The desired language for string representation of the numeric $value. An empty sequence must be passed in even if a user doesn't want to specify this argument.
    * @param { XsString } [letterValue] - Same as letter-value attribute in xsl:number. This argument is ignored during formatting as of now. It may be used in future. An empty sequence must be passed in even if a user doesn't want to specify this argument.
    * @param { XsString } [ordchar] - If $ordchar is "yes" then ordinal numbering is attempted. If this is any other string, including an empty string, then cardinal numbering is generated. An empty sequence must be passed in even if a user doesn't want to specify this argument.
    * @param { XsString } [zeroPadding] - Value of $zero-padding is used to pad integer part of a number on the left and fractional part on the right, if needed. An empty sequence must be passed in even if a user doesn't want to specify this argument.
    ...
    * @param { XsInteger } [groupingSize] - Represents size of the group, i.e. the number of digits before after which grouping separator is inserted. An empty sequence must be passed in even if a user doesn't want to specify this argument.
    * @returns { XsString }
    */
formatNumber(...args) {
    const namer = bldrbase.getNamer(args, 'value');
...
/**
    * Parses a string as XML, returning one or more document nodes. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xdmp.unquote|xdmp.unquote}
    * @method planBuilder.xdmp#unquote
    * @since 2.1.1
    * @param { XsString } [arg] - Input to be unquoted.
    * @param { XsString } [defaultNamespace] - Default namespace for nodes in the first parameter.
...
unquote(...args) {
    const namer = bldrbase.getNamer(args, 'arg');
    const paramdefs = [['arg', [types.XsString, PlanColumn, PlanParam], true, false], ['default-namespace', [types.XsString, PlanColumn, PlanParam], false, false], ['options', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'xdmp.unquote', 1, new Set(['arg', 'default-namespace', 'options']), paramdefs, args) :
        bldrbase.makePositionalArgs('xdmp.unquote', 1, false, paramdefs, args);
    return new types.DocumentNode('xdmp', 'unquote', checkedArgs);
...
class PlanXsStringMap extends types.ServerType {
...
class PlanNamespaceBindings extends types.ServerType {
...
/**
  ...
  * @namespace planBuilder.PatchBuilder
  * @since 2.1.1
  */
class PlanPatchBuilder extends types.ServerType {

  constructor(ns, fn, args) {
    super(ns, fn, args);
  }
/**
    * Insert a new node after another node. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.insertAfter|op.insertAfter}
    * @method planBuilder.PatchBuilder#insertAfter
    * @since 2.1.1
    * @param { XsString } [path] - The Patch Builder Plan. You can either use the XQuery =&gt; chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { Item } [node] - The path to insert the node after.
    * @returns { planBuilder.PatchBuilder }
    */
insertAfter(...args) {
    const namer = bldrbase.getNamer(args, 'path');
    const paramdefs = [['path', [types.XsString], true, false], ['node', [types.Item, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanPatchBuilder.insertAfter', 2, new Set(['path', 'node']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanPatchBuilder.insertAfter', 2, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'insert-after', checkedArgs);

    }
/**
    * Insert a new node before another node. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.insertBefore|op.insertBefore}
    * @method planBuilder.PatchBuilder#insertBefore
    * @since 2.1.1
    * @param { XsString } [path] - The Patch Builder Plan. You can either use the XQuery =&gt; chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { Item } [node] - The path to insert the node before.
    * @returns { planBuilder.PatchBuilder }
    */
insertBefore(...args) {
    const namer = bldrbase.getNamer(args, 'path');
    const paramdefs = [['path', [types.XsString], true, false], ['node', [types.Item, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanPatchBuilder.insertBefore', 2, new Set(['path', 'node']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanPatchBuilder.insertBefore', 2, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'insert-before', checkedArgs);

    }
/**
    * Insert a node as child. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.insertChild|op.insertChild}
    * @method planBuilder.PatchBuilder#insertChild
    * @since 2.1.1
    * @param { XsString } [path] - The Patch Builder Plan. You can either use the XQuery =&gt; chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { Item } [node] - The path to insert the child.
    * @returns { planBuilder.PatchBuilder }
    */
insertChild(...args) {
    const namer = bldrbase.getNamer(args, 'path');
    const paramdefs = [['path', [types.XsString], true, false], ['node', [types.Item, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanPatchBuilder.insertChild', 2, new Set(['path', 'node']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanPatchBuilder.insertChild', 2, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'insert-child', checkedArgs);

    }
/**
    * This method is specific for JSON and inserts a key/value pair to an object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.insertNamedChild|op.insertNamedChild}
    * @method planBuilder.PatchBuilder#insertNamedChild
    * @since 2.1.1
    * @param { XsString } [path] - The Patch Builder Plan. You can either use the XQuery =&gt; chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { XsString } [key] - The path which returns an JSON Object.
    * @param { Item } [node] - The key to insert.
    * @returns { planBuilder.PatchBuilder }
    */
insertNamedChild(...args) {
    const namer = bldrbase.getNamer(args, 'path');
    const paramdefs = [['path', [types.XsString], true, false], ['key', [types.XsString], true, false], ['node', [types.Item, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanPatchBuilder.insertNamedChild', 3, new Set(['path', 'key', 'node']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanPatchBuilder.insertNamedChild', 3, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'insert-named-child', checkedArgs);

    }
/**
    * This method deletes a document from the database. If the document does not exist, this method does not throw an error. Delete a node. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.remove|op.remove}
    * @method planBuilder.PatchBuilder#remove
    * @since 2.1.1
    * @param { XsString } [path] - If this column is not specified then it assumes a column 'uri' is present. This can be a string of the uri column name or an op:col. Use op:view-col or op:schema-col if you need to identify columns in the two views that have the same column name. This can also be a map object specify the uri column name.
    * @returns { planBuilder.PatchBuilder }
    */
remove(...args) {
    const paramdef = ['path', [types.XsString], true, false];
    const checkedArgs = bldrbase.makeSingleArgs('PlanPatchBuilder.remove', 1, paramdef, args);
    return new PlanPatchBuilder('op', 'remove', checkedArgs);
    }
/**
    * Replace a node with another node. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.replace|op.replace}
    * @method planBuilder.PatchBuilder#replace
    * @since 2.1.1
    * @param { XsString } [path] - The Patch Builder Plan. You can either use the XQuery =&gt; chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { Item } [node] - The path to replace.
    * @returns { planBuilder.PatchBuilder }
    */
replace(...args) {
    const namer = bldrbase.getNamer(args, 'path');
    const paramdefs = [['path', [types.XsString], true, false], ['node', [types.Item, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanPatchBuilder.replace', 2, new Set(['path', 'node']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanPatchBuilder.replace', 2, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'replace', checkedArgs);

    }
/**
    * Replace a child if it exist, or insert if it does not exist. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.replaceInsertChild|op.replaceInsertChild}
    * @method planBuilder.PatchBuilder#replaceInsertChild
    * @since 2.1.1
    * @param { XsString } [parentPath] - The Patch Builder Plan. You can either use the XQuery =&gt; chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { XsString } [pathToReplace] - The parent path to insert/replace.
    * @param { Item } [node] - The path to insert/replace which is relative to parent-path.
    * @returns { planBuilder.PatchBuilder }
    */
replaceInsertChild(...args) {
    const namer = bldrbase.getNamer(args, 'parent-path');
    const paramdefs = [['parent-path', [types.XsString], true, false], ['path-to-replace', [types.XsString], true, false], ['node', [types.Item, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanPatchBuilder.replaceInsertChild', 2, new Set(['parent-path', 'path-to-replace', 'node']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanPatchBuilder.replaceInsertChild', 2, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'replace-insert-child', checkedArgs);

    }
/**
    * Replace the value of a path with a new value. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.replaceValue|op.replaceValue}
    * @method planBuilder.PatchBuilder#replaceValue
    * @since 2.1.1
    * @param { XsString } [path] - The Patch Builder Plan. You can either use the XQuery =&gt; chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { Item } [value] - The path to replace the value.
    * @returns { planBuilder.PatchBuilder }
    */
replaceValue(...args) {
    const namer = bldrbase.getNamer(args, 'path');
    const paramdefs = [['path', [types.XsString], true, false], ['value', [types.Item, PlanColumn, PlanParam], true, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanPatchBuilder.replaceValue', 2, new Set(['path', 'value']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanPatchBuilder.replaceValue', 2, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'replace-value', checkedArgs);
...
/**
    ...
    * @since 2.1.1
    * @param { PlanModifyPlan } [right] - The row set from the right view.
    * @param { PlanJoinKey } [keys] - Equality condition(s) expressed using one or more calls to the function op:on. These conditions are used to compare the left and right rows.
    * @param { XsBoolean } [condition] - A boolean expression used to compare the left and right rows. See Boolean Expression Functions for the list of functions used to build boolean expressions.
    * @returns { planBuilder.ModifyPlan }
    */
existsJoin(...args) {
...
/**
    * This method adds an uri column and a document column to rows based on an existing source column having a value of a document uri (which can be used to read other documents) or a fragment id (which can be used to read the source documents for rows). If the fragment id column is null in the row, the row is dropped from the rowset.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/ModifyPlan.prototype.joinDocAndUri|ModifyPlan.prototype.joinDocAndUri}
    * @method planBuilder.ModifyPlan#joinDocAndUri
    * @since 2.1.1
    * @param { PlanColumnName } [docCol] - The document column to add to the rows. This can be a string or a column, op:col, op:view-col or op:schema-col, specifying the name of the new column that should have the document as its value.
    * @param { PlanColumn } [uriCol] - The uri column to add to the rows. This can be a string or a column, op:col, op:view-col or op:schema-col, specifying the name of the new column that should have the document uri as its value.
...
joinDocAndUri(...args) {
    const namer = bldrbase.getNamer(args, 'docCol');
    const paramdefs = [['docCol', [PlanColumn, types.XsString], true, false], ['uriCol', [PlanColumn], true, false], ['sourceCol', [PlanColumn], true, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.joinDocAndUri', 3, new Set(['docCol', 'uriCol', 'sourceCol']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanModifyPlan.joinDocAndUri', 3, false, paramdefs, args);
    return new PlanModifyPlan(this, 'op', 'join-doc-and-uri', checkedArgs);
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [uriCol] - The new column which contains the document uris. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col.
...
/**
    ...
    * @since 2.1.1
    * @param { PlanSortKeyName } [keys] - The specified column or sortdef output from the op:asc or op:desc function. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
    * @returns { planBuilder.ModifyPlan }
    */
orderBy(...args) {
...
/**
    * Add an error-handler to the Optic Pipeline to catch Optic Update runtime errors. The runtime errors are added in the errors column. If no error occurred the value of the error column is null. When added, the error-handler should be the last operator before op:result. Provides a client interface to a server function. See {@link http://docs.marklogic.com/ModifyPlan.prototype.onError|ModifyPlan.prototype.onError}
    * @method planBuilder.ModifyPlan#onError
    * @since 2.1.1
    * @param { XsString } [action] - Valid options are: "fail" - stop processing and "continue" - add an error to the error column and continue processing.
    * @param { PlanExprColName } [errorColumn] - An optional error column which is not used in the plan. If this parameter is not passed in 'sys.errors' is used.
    * @returns { planBuilder.ModifyPlan }
    */
onError(...args) {
    const namer = bldrbase.getNamer(args, 'action');
    const paramdefs = [['action', [types.XsString], true, false], ['error-column', [PlanExprCol, PlanColumn, types.XsString], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.onError', 1, new Set(['action', 'error-column']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanModifyPlan.onError', 1, false, paramdefs, args);
    return new PlanModifyPlan(this, 'op', 'on-error', checkedArgs);

    }
/**
    * Builds a patch operation including a sequence of inserts, replaces, replace-inserts and deletes. Provides a client interface to a server function. See {@link http://docs.marklogic.com/ModifyPlan.prototype.patch|ModifyPlan.prototype.patch}
    * @method planBuilder.ModifyPlan#patch
    * @since 2.1.1
    * @param { PlanExprColName } [docColumn] - The document column which need to be patched.
    * @param { PlanPatchBuilder } [patchDef] - The patch definition as op:patch-builder
    * @returns { planBuilder.ModifyPlan }
    */
patch(...args) {
    const namer = bldrbase.getNamer(args, 'doc-column');
    const paramdefs = [['doc-column', [PlanExprCol, PlanColumn, types.XsString], true, false], ['patch-def', [PlanPatchBuilder], true, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.patch', 2, new Set(['doc-column', 'patch-def']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanModifyPlan.patch', 2, false, paramdefs, args);
    return new PlanModifyPlan(this, 'op', 'patch', checkedArgs);
...
/**
    ...
    * @since 2.1.1
    * @param { PlanExprColName } [columns] - The columns to project from the input rows. The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with op:as.
...
/**
    * This method deletes a document from the database. If the document does not exist, this method does not throw an error. Delete a node. Provides a client interface to a server function. See {@link http://docs.marklogic.com/ModifyPlan.prototype.remove|ModifyPlan.prototype.remove}
...
/**
    ...
    * @since 2.1.1
    * @param { PlanDocColsIdentifier } [cols] - The source column to join. This is either an op:fragment-id-col specifying a fragment id column or a uri column which contains document uris. The uri column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.Joining on a fragment id is more efficient than joining on an uri column.
...
/**
    ...
    * @since 2.1.1
    * @param { PlanExprColName } [inputColumn] - The input column, which contains an array, to flatten into rows. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
    ...
    */
unnestInner(...args) {
    const namer = bldrbase.getNamer(args, 'inputColumn');
    const paramdefs = [['inputColumn', [PlanExprCol, PlanColumn, types.XsString], true, false], ['valueColumn', [PlanExprCol, PlanColumn, types.XsString], true, false], ['ordinalColumn', [PlanExprCol, PlanColumn, types.XsString], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.unnestInner', 2, new Set(['inputColumn', 'valueColumn', 'ordinalColumn']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanModifyPlan.unnestInner', 2, false, paramdefs, args);
    return new PlanModifyPlan(this, 'op', 'unnest-inner', checkedArgs);
...
/**
    ...
    * @returns { planBuilder.ModifyPlan }
    */
unnestLeftOuter(...args) {
    const namer = bldrbase.getNamer(args, 'inputColumn');
    const paramdefs = [['inputColumn', [PlanExprCol, PlanColumn, types.XsString], true, false], ['valueColumn', [PlanExprCol, PlanColumn, types.XsString], true, false], ['ordinalColumn', [PlanExprCol, PlanColumn, types.XsString], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.unnestLeftOuter', 2, new Set(['inputColumn', 'valueColumn', 'ordinalColumn']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanModifyPlan.unnestLeftOuter', 2, false, paramdefs, args);
    return new PlanModifyPlan(this, 'op', 'unnest-left-outer', checkedArgs);

    }
/**
    * This method can be used to find the shortest path between two nodes in a given graph. Provides a client interface to a server function. See {@link http://docs.marklogic.com/ModifyPlan.prototype.shortestPath|ModifyPlan.prototype.shortestPath}
    * @method planBuilder.ModifyPlan#shortestPath
    * @since 2.1.1
    * @param { PlanExprColName } [start] - The column representing the input starting subject of the shortest path search. The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col.
    * @param { PlanExprColName } [end] - The column representing the input ending object of the shortest path search. The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col.
    * @param { PlanExprColName } [path] - The column is the output column representing the actual shortest path(s) taken from start to end. Values are not returned for this column if this is the empty sequence.The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col.
    * @param { PlanExprColName } [length] - The column is the output column representing the length of the shortest path. Value is not returned for this column if this is the empty sequence.The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col.
    * @param { PlanExprColName } [weight] - 
    * @returns { planBuilder.ModifyPlan }
    */
shortestPath(...args) {
    const namer = bldrbase.getNamer(args, 'start');
    const paramdefs = [['start', [PlanExprCol, PlanColumn, types.XsString], true, false], ['end', [PlanExprCol, PlanColumn, types.XsString], true, false], ['path', [PlanExprCol, PlanColumn, types.XsString], false, false], ['length', [PlanExprCol, PlanColumn, types.XsString], false, false], ['weight', [PlanExprCol, PlanColumn, types.XsString], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.shortestPath', 2, new Set(['start', 'end', 'path', 'length', 'weight']), paramdefs, args) :
...
sampleBy(...args) {
    ...
    const checkedArgs = bldrbase.makeSingleArgs('PlanAccessPlan.sampleBy', 0, paramdef, args);
...
/**
    ...
    */
/**
    * Builds expressions to call functions in the vec server library
    * for a row pipeline.
    * @namespace planBuilder.vec
    * @since 2.1.1
    */
/**
...
this.vec = (fieldOverrides.vec !== void 0) ? fieldOverrides.vec : new VecExpr();
...
this.xs = (fieldOverrides.xs !== void 0) ? fieldOverrides.xs : new XsExpr();
  ...
  /**
    ...
    * @since 2.1.1
    * @param { XsAnyAtomicType } [left] - The left value expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or expressions.
    * @param { XsAnyAtomicType } [right] - The right value expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or expressions.
    * @returns { XsNumeric }
    */
add(...args) {
...
/**
    ...
    * @since 2.1.1
    * @param { XsAnyAtomicType } [left] - The left numeric expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or expressions.
    * @param { XsAnyAtomicType } [right] - The right numeric expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or expressions.
    * @returns { XsNumeric }
    */
divide(...args) {
        const namer = bldrbase.getNamer(args, 'left');
...
/**
    ...
    * @since 2.1.1
    * @param { XsAnyAtomicType } [left] - The left value expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or an expression.
    * @param { XsAnyAtomicType } [right] - The right value expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or an expression.
    * @returns { XsBoolean }
    */
eq(...args) {
        const namer = bldrbase.getNamer(args, 'left');
...
/**
    ...
    * @since 2.1.1
    * @param { XsAnyAtomicType } [value] - The expression providing the value to test. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, which contains numbers or an expression that outputs a number.
...
/**
    * This function tests whether the value of an expression is null in the row where the expression might be as simple as a column identified by column parameter function , such as op:col. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.isDefined|op.isDefined}
...
/**
    * This function returns true if any of the specified boolean expressions return true. Otherwise, it returns false.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.or|op.or}
    * @method planBuilder#or
    * @since 2.1.1
    * @param { XsAnyAtomicType } [left] - The left value expression. See Boolean Expression Functions for the list of functions used to build boolean expressions.
    * @param { XsAnyAtomicType } [right] - The right value expression.
    * @returns { XsBoolean }
    */
or(...args) {
...
/**
    ...
    * @since 2.1.1
    * @param { XsAnyAtomicType } [left] - The left numeric expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or an expression.
    * @param { XsAnyAtomicType } [right] - The right numeric expression. It can be a number, a column function such as op:col, op:view-col, or op:schema-col, or an expression.
    * @returns { XsNumeric }
    */
subtract(...args) {
        const namer = bldrbase.getNamer(args, 'left');
    ...
    * Create a patch builder which can be used to chain patch operations. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.patchBuilder|op.patchBuilder}
    * @method planBuilder#patchBuilder
    * @since 2.1.1
    * @param { XsString } [contextPath] - The context path to patch.
    * @param { PlanXsStringMap } [namespaces] - Namespaces prefix (key) and uri (value).
    * @returns { planBuilder.PatchBuilder }
    */
patchBuilder(...args) {
    const namer = bldrbase.getNamer(args, 'context-path');
    const paramdefs = [['context-path', [types.XsString], true, false], ['namespaces', [PlanXsStringMap], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanBuilder.patchBuilder', 1, new Set(['context-path', 'namespaces']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanBuilder.patchBuilder', 1, false, paramdefs, args);
    return new PlanPatchBuilder('op', 'patch-builder', checkedArgs);
...
/**
    ...
    * @since 2.1.1
    * @param { PlanTriplePosition } [subjects] - One column or one or more literal values, such as the literal returned by a sem:iri call. The column can be named with a column function such as op:col, op:view-col, or op:schema-col.
    * @param { PlanTriplePosition } [predicates] - One column or one or more literal values, such as the literal returned by a sem.iri call. The column can be named with a column function such as op:col, op:view-col, or op:schema-col.
    * @param { PlanTriplePosition } [objects] - One column or one or more literal values, such as the literal returned by a sem:iri call. The column can be named with a column function such as op:col, op:view-col, or op:schema-col.
...
/**
    ...
    * @param { PlanSparqlOption } [option] - Options consisting of key-value pairs that set options. At present, the options consist of dedup and base. Option dedup can take an on|off value to enable or disable deduplication. Deduplication is off by default. Option base takes a string as the initial base IRI for the query.
    * @returns { planBuilder.ModifyPlan }
    */
fromSPARQL(...args) {
...
/**
    * This function matches and returns the uri for documents. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.fromDocUris|op.fromDocUris}
...
/**
    ...
    * @since 2.1.1
    * @param { PlanExprColName } [left] - The rows from the left view. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
    * @param { PlanExprColName } [right] - The row set from the right view. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
...
/**
    ...
    * @since 2.1.1
    * @param { PlanExprColName } [keys] - The columns (if any) to use as grouping keys. The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with op:as.
...
/**
    ...
    * @since 2.1.1
    * @param { PlanExprColName } [keys] - The columns to use as grouping keys. The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with op:as.
    * @returns { planBuilder.PlanGroup }
    */
rollup(...args) {
...
/**
    ...
    * @param { PlanExprColName } [keys] - The columns (if any) to use as grouping keys. The columns can be named with a string or a a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with op:as.
...
/**
    ...
    * @param { PlanExprColName } [key] - The identifier for the existing column with the values (typically numeric or datetime) to put into buckets. The columns can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with op:as.
...
/**
    ...
    * @param { PlanExprColName } [column] - The column to be aggregated. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [name] - The name to be used for the aggregated column.
    * @param { PlanExprColName } [column] - The columns to be aggregated. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
    * @param { PlanValueOption } [option] - The options can take a values key with a 'distinct' value to aggregate the distinct values of the column.
    * @returns { planBuilder.PlanAggregateCol }
    */
arrayAggregate(...args) {
    const namer = bldrbase.getNamer(args, 'name');
...
/**
    ...
    * @param { PlanExprColName } [column] - The columns to be counted. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
...
/**
    ...
    * @param { PlanExprColName } [column] - The name of the column with the values to be concatenated for the group. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
    * @param { PlanGroupConcatString } [options] - The options can take a values key with a 'distinct' value to concat the distinct values of the column. In addition to the values key, the options can take a separator key specifying a separator character. The value can be a string or placeholder parameter.
    * @returns { planBuilder.PlanAggregateCol }
    */
groupConcat(...args) {
    const namer = bldrbase.getNamer(args, 'name');
...
/**
    ...
    * @param { PlanExprColName } [column] - The column to flag as a grouping key. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with op:as.
    * @returns { planBuilder.PlanAggregateCol }
    */
hasGroupKey(...args) {
    const namer = bldrbase.getNamer(args, 'name');
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [name] - The name to be used for the aggregated column.
    * @param { PlanExprColName } [column] - The column with the values to add. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
    * @param { PlanValueOption } [option] - The options can take a values key with a 'distinct' value to sum the distinct values of the column.
    * @returns { planBuilder.PlanAggregateCol }
    */
sum(...args) {
    const namer = bldrbase.getNamer(args, 'name');
...
/**
    ...
    * @param { XsAnyAtomicType } [arg] - The options can take a values key with a 'distinct' value to aggregate the distinct values of the column and an arg key specifying an argument for the user-defined aggregate. The value can be a string or placeholder parameter.
    * @returns { planBuilder.PlanAggregateCol }
    */
uda(...args) {
    const namer = bldrbase.getNamer(args, 'name');
...
/**
    * This function sorts the rows by the values of the specified column in ascending order. The results are used by the op:order-by function. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.asc|op.asc}
    * @method planBuilder#asc
    * @since 2.1.1
    * @param { PlanExprColName } [column] - The column to order the output. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
...
/**
    * This function sorts the rows by the values of the specified column in descending order. The results are used by the op:order-by function. Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.desc|op.desc}
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [column] - The name of the column from which to extract the child nodes. The column can be named with a string or a column function such as op:col, op:view-col, or op:schema-col, or constructed from an expression with the op:as function.
    * @param { XsString } [path] - An XPath (specified as a string) to apply to each node.
    * @param { PlanNamespaceBindings } [namespaceBindings] - A map of namespace bindings. The keys should be namespace prefixes and the values should be namespace URIs. These namespace bindings will be added to the in-scope namespace bindings in the evaluation of the path.
    * @returns { Node }
    */
xpath(...args) {
    const namer = bldrbase.getNamer(args, 'column');
    const paramdefs = [['column', [PlanColumn, types.XsString], true, false], ['path', [types.XsString, PlanColumn, PlanParam], true, false], ['namespace-bindings', [PlanNamespaceBindings], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanBuilder.xpath', 2, new Set(['column', 'path', 'namespace-bindings']), paramdefs, args) :
