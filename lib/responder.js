...
function responseDispatcher(response) {
 ...
 // if(response.headers['ml-effective-timestamp']){response.headers['ml-effective-timestamp'] = ''};
  console.log('response.rawHeaders is')
 // console.log(response.rawHeaders)
  ...
  if (isMultipart) {
    ...
    console.log('response.hearders is ********************')
...
console.log('line 474')
  ...
  var partHeadersListener = function promisePartHeadersListener(headers) {
    ...
    console.log('partListener - line 566')
