...
function onTransformAllInit(output) {
  ...
  if(jobState.jobOptions.transform.length >1){
    ...
    for(let paramName of Object.keys(transformParams)){
  ...
  requestOptions.path = mlutil.databaseParam(connectionParams, jobState.endpoint);
