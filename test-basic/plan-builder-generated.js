...
describe('plan builder', function() {
  describe('expression functions', function() { 
    ...
    it('cts.boxNorth#1', function(done) {
        testPlan([p.cts.box(1, 2, 3, 4)], p.cts.boxNorth(p.col("1")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('3');
            done();
        }).catch(done);
    }); 
    it('cts.boxSouth#1', function(done) {
        testPlan([p.cts.box(1, 2, 3, 4)], p.cts.boxSouth(p.col("1")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('1');
            done();
        }).catch(done);
    }); 
    it('cts.boxWest#1', function(done) {
        testPlan([p.cts.box(1, 2, 3, 4)], p.cts.boxWest(p.col("1")))
          .then(function(response) { 
    ...
    it('cts.pointLongitude#1', function(done) {
        testPlan([p.cts.point(1, 2)], p.cts.pointLongitude(p.col("1")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('2');
            done();
        }).catch(done);
    ...
    it('geo.arcIntersection#4', function(done) {
        testPlan([p.cts.point(1, 2), p.cts.point(1, 2), p.cts.point(1, 2), p.cts.point(1, 2)], p.geo.arcIntersection(p.col("1"), p.col("2"), p.col("3"), p.col("4")))
          .then(function(response) { 
            should(getResult(response).value).eql("1,2");
            done();
        }).catch(done);
    ...
    it('geo.destination#3', function(done) {
        testPlan([p.cts.point(1, 2), p.xs.double(1.2), p.xs.double(1.2)], p.geo.destination(p.col("1"), p.col("2"), p.col("3")))
          .then(function(response) { 
    ...
    it('geo.distance#2', function(done) {
        testPlan([p.cts.point(1, 2), p.cts.point(1, 2)], p.geo.distance(p.col("1"), p.col("2")))
          .then(function(response) { 
    ...
    it('geo.distanceConvert#3', function(done) {
        testPlan([p.xs.double(1), p.xs.string("miles"), p.xs.string("km")], p.geo.distanceConvert(p.col("1"), p.col("2"), p.col("3")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('1.609344');
            done();
        }).catch(done);
    }); 
    it('geo.ellipsePolygon#5', function(done) {
        testPlan([p.cts.point(1, 2), p.xs.double(1.2), p.xs.double(1.2), p.xs.double(1.2), p.xs.double(1.2)], p.geo.ellipsePolygon(p.col("1"), p.col("2"), p.col("3"), p.col("4"), p.col("5")))
          .then(function(response) { 
    ...
    it('geo.geohashDecodePoint#1', function(done) {
        testPlan([p.xs.string("s01mtw")], p.geo.geohashDecodePoint(p.col("1")))
          .then(function(response) { 
            should(getResult(response).value).eql("1.0025024,2.0050049");
            done();
        }).catch(done);
    }); 
    ...
    it('geo.geohashPrecisionDimensions#1', function(done) {
        testPlan([p.xs.integer(4)], p.geo.geohashPrecisionDimensions(p.col("1")))
          .then(function(response) { 
            should(getResult(response).value).eql([0.17578125, 0.3515625]);
            done();
        }).catch(done);
    }); 
    ...
    it('geo.geohashSubhashes#2', function(done) {
        testPlan([p.xs.string("s01mtw"), p.xs.string("S")], p.geo.geohashSubhashes(p.col("1"), p.col("2")))
          .then(function(response) { 
            should(getResult(response).value).eql(["s01mtwh", "s01mtwj", "s01mtwk", "s01mtwm", "s01mtwn", "s01mtwp", "s01mtwq", "s01mtwr", "s01mtws", "s01mtwt", "s01mtwu", "s01mtwv", "s01mtww", "s01mtwx", "s01mtwy", "s01mtwz"]);
            done();
        }).catch(done);
    }); 
    ...
    it('geo.validateWkt#1', function(done) {
        testPlan([p.xs.string("POINT(2 1)")], p.geo.validateWkt(p.col("1")))
          .then(function(response) { 
            should(getResult(response).value).eql(true);
            done();
        }).catch(done);
    ...
    it('sql.glob#2', function(done) {
        testPlan([p.xs.string("abcdefg"), p.xs.string("a??d*g")], p.sql.glob(p.col("1"), p.col("2")))
          .then(function(response) { 
            should(getResult(response).value).eql(true);
            done();
        }).catch(done);
    ...
    it('sql.ifnull#2', function(done) {
        testPlan([p.xs.string("a"), p.xs.string("b")], p.sql.ifnull(p.col("1"), p.col("2")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('a');
            done();
        }).catch(done);
    ...
    it('sql.like#2', function(done) {
        testPlan([p.xs.string("abcdefg%h"), p.xs.string("a__d%g!%h")], p.sql.like(p.col("1"), p.col("2")))
          .then(function(response) { 
            should(getResult(response).value).eql(false);
            done();
        }).catch(done);
    }); 
    it('sql.like#3', function(done) {
        testPlan([p.xs.string("abcdefg%h"), p.xs.string("a__d%g!%h"), p.xs.string("!")], p.sql.like(p.col("1"), p.col("2"), p.col("3")))
          .then(function(response) { 
            should(getResult(response).value).eql(true);
            done();
        }).catch(done);
    ...
    it('sql.nullif#2', function(done) {
        testPlan([p.xs.string("a"), p.xs.string("b")], p.sql.nullif(p.col("1"), p.col("2")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('a');
            done();
        }).catch(done);
    ...
    it('sql.soundex#1', function(done) {
        testPlan([p.xs.string("word")], p.sql.soundex(p.col("1")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('W630');
            done();
        }).catch(done);
    }); 
    it('sql.space#1', function(done) {
        testPlan([p.xs.double(2)], p.sql.space(p.col("1")))
          .then(function(response) { 
            should(String(getResult(response).value)).equal('  ');
            done();
        }).catch(done);
    }); 
    it('sql.strpos#2', function(done) {
        testPlan([p.xs.string("abc"), p.xs.string("b")], p.sql.strpos(p.col("1"), p.col("2")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('2');
            done();
        }).catch(done);
    }); 
    it('sql.strpos#3', function(done) {
        testPlan([p.xs.string("abc"), p.xs.string("b"), p.xs.string("http://marklogic.com/collation/")], p.sql.strpos(p.col("1"), p.col("2"), p.col("3")))
          .then(function(response) { 
            should(String(getResult(response).value).replace(/^ /, '')).equal('2');
            done();
        }).catch(done);
